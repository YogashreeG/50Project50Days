            ...
            <><header>
                <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css" />
                    ...
                    <div className='result-container'>
                        <input type="text" value={handelText} onChange={(e) => setHandelText(e.target.value)}></input>
                    ...
                    <div className='settings'>
                        <div className='setting'>
                            ...
                            <input type={"number"} id="length" min={"4"} max={"20"} value={word.length} onChange={(e) => setwordLength(e.target.value)} />
                        </div>
                        <div className='setting'>
                            <label>Include uppercase letter</label>
                            <input type="checkbox" id='uppercase' value={word.uppercase} onChange={handelChangeUppercase} />
                        </div>
                        <div className='setting'>
                            <label>Include lowercase letter</label>
                            <input type="checkbox" id='lowercase' value={word.lowercase} onChange={handelChangelowercase} />
                        </div>
                        <div className='setting'>
                            <label>Include number</label>
                            <input type="checkbox" id='number' value={word.number} onChange={handelChangeNumber} />
                        </div>
                        <div className='setting'>
                            <label>Include symbols</label>
                            <input type="checkbox" id='symbol' value={word.symbols} onChange={handelChangeSymbols} />
                        </div>
                    </div>
                    <button className='btn' id='generate' onClick={generatepwd}>Generate Password</button>
                </div></>
        );
    }
